#ifndef GOAL_EV_DUAL_VECTOR_WEIGHT_HPP
#define GOAL_EV_DUAL_VECTOR_WEIGHT_HPP

/** \file goal_ev_dual_vector_weight.hpp */
...
class DualVectorWeight : public PHX::EvaluatorWithBaseImpl<TRAITS>,
 ...
 private:
  ...
  RCP<Field> z;
  RCP<Field> z_fine;
  PHX::MDField<ScalarT, Elem, Node, IP, Dim> w;
  PHX::MDField<ScalarT, Elem, Node, IP, Dim, Dim> grad_w;
};
