#ifndef GOAL_EV_QOI_VECTOR_POINT_HPP
#define GOAL_EV_QOI_VECTOR_POINT_HPP

/** \file goal_ev_qoi_vector_point.hpp */
...
class QoIVectorPoint : public PHX::EvaluatorWithBaseImpl<TRAITS>,
 ...
 public:
  ...
  QoIVectorPoint(RCP<Field> u, RCP<Indexer> i, std::string const& set);
