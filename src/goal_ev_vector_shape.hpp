...
/** \brief Compute the shape functions associated with a vector field.
  * \details This evaluator fills in multidimensional arrays for the
  * shape functions and the shape function gradients for elements contained
  * in the workset. This shape is fully determined by the \ref goal::Field
  ...
  * an integration point, multiplied by the numerical quadrature weight at
