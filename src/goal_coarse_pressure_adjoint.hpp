#ifndef goal_coarse_pressure_adjoint_hpp
#define goal_coarse_pressure_adjoint_hpp

#include "goal_scalar_weight.hpp"

namespace goal {

class CoarsePressureAdjoint : public ScalarWeight {
  public:
    CoarsePressureAdjoint(apf::Field* z);
